...
date "+%c"
java -cp .:./* wumpusworld.solutions.ws1112.JTSBMMSSNR.TestGoldsammelAgent BS "H${ANZAHL}I" $RNDSEED 1>/dev/null 2>> "../Error.txt"
echo "Starte mit Uniforme Kostensuche"
date "+%c"
java -cp .:./* wumpusworld.solutions.ws1112.JTSBMMSSNR.TestGoldsammelAgent UK "H${ANZAHL}I" $RNDSEED 1>/dev/null 2>> "../Error.txt"
echo "Starte mit A*"
date "+%c"
java -cp .:./* wumpusworld.solutions.ws1112.JTSBMMSSNR.TestGoldsammelAgent AS "H${ANZAHL}I" $RNDSEED 1>/dev/null 2>> "../Error.txt"
